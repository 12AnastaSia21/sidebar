...
ЗАДАНИЕ ВЫПОЛНЕНО. Тема Sidebar зависит от темы браузера, которая связана с темой Устройства пользователя. Результат можно посмотреть по [ссылке](http://vidrochka.xyz:7205/).
